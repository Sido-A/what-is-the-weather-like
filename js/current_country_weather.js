...
(() => {
  ...
  const success = (position) => {
    ...
    BASE_URL.searchParams.set("lat", latitude);
    BASE_URL.searchParams.set("lon", longitude);
    BASE_URL.searchParams.set("units", api_units_options);
    BASE_URL.searchParams.set("exclude", api_exclude_options);
    BASE_URL.searchParams.set("appid", api_key);
    fetchWeatherData(BASE_URL.href);
    console.log("FILE", BASE_URL.href);
  };
  const error = () => {
...
const fetchWeatherData = (weather_api_url) => {
